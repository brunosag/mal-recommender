...
export function sortAnimeRecommendationsList(animeRecommendationsList, sortType) {
  if (sortType === 'points') return animeRecommendationsList.sort((a, b) => b.points - a.points);
  if (sortType === 'title') return animeRecommendationsList.sort((a, b) => a.title.jp.localeCompare(b.title.jp));
  if (sortType === 'mean') return animeRecommendationsList.sort((a, b) => b.mean - a.mean);
  if (sortType === 'members') return animeRecommendationsList.sort((a, b) => b.members - a.members);
